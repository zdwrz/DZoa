...
<div class="row">
    ...
    <div class="col-md-6" id="button_div">
        <button type="button" class="btn btn-primary" id="upload_btn" data-toggle="modal" data-target="#upload_file_modal_dialog"><span class="glyphicon glyphicon-cloud-upload"></span>Upload</button>
