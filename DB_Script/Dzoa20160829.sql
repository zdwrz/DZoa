...
CREATE TABLE `user_doc_info` (
  ...
  KEY `user_doc_info_doc_id_fk_idx` (`doc_id`),
  CONSTRAINT `user_doc_info_doc_id_fk` FOREIGN KEY (`doc_id`) REFERENCES `docs` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2016-08-29 18:18:43
